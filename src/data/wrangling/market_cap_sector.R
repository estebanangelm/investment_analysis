...
#
# Usage: Rscript market_cap_sector.R data/original/fundamentals.csv data/original/prices.csv 
#        data/original/securities.csv data/processed/market_cap_sector.csv
...
write_csv(market_cap_sector,paste(root,destination_1,sep=""))
